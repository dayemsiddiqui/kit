...
var xhr_default = isXHRAdapterSupported && function(config3) {
  return new Promise(function dispatchXhrRequest(resolve, reject2) {
    ...
    request.onabort = function handleAbort() {
      ...
      reject2(new AxiosError_default("Request aborted", AxiosError_default.ECONNABORTED, config3, request));
      request = null;
    };
    ...
    if (_config.cancelToken || _config.signal) {
      onCanceled = (cancel) => {
        ...
        reject2(!cancel || cancel.type ? new CanceledError_default(null, config3, request) : cancel);
        request.abort();
        request = null;
      };
